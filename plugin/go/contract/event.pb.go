...
// DcbStateEvent is the DCB player-state event payload. state holds the raw
// engine.EncodeState bytes; declared in ContractConfig.EventTypeUrls as
// type.googleapis.com/types.DcbStateEvent so the plugin schema check resolves it.
...
const file_event_proto_rawDesc = "" +
	...
	"\x03msg\"5\n" +
	"\vEventCustom\x12&\n" +
	"\x03msg\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\x03msg\"W\n" +
	"\rDcbStateEvent\x12\x14\n" +
	"\x05state\x18\x01 \x01(\fR\x05state\x12\x16\n" +
	"\x06height\x18\x02 \x01(\x04R\x06height\x12\x18\n" +
	"\aaddress\x18\x03 \x01(\fR\aaddressB.Z,github.com/canopy-network/go-plugin/contractb\x06proto3"
...
var file_event_proto_goTypes = []any{
	...
	(*DcbStateEvent)(nil), // 2: types.DcbStateEvent
	(*anypb.Any)(nil),     // 3: google.protobuf.Any
}
var file_event_proto_depIdxs = []int32{
	1, // 0: types.Event.custom:type_name -> types.EventCustom
	3, // 1: types.EventCustom.msg:type_name -> google.protobuf.Any
